...
export class ContactComponent implements OnInit {
  ...
  map_address='';
  captcha = "";
  constructor(private apiService: ApiService, public sanitizer: DomSanitizer,private toastr: ToastrService) { }
 ...
 htmlToPlaintext(text) {
  ...
  contactUs(form: NgForm){
    if(!this.model.name || !this.model.subject || !this.model.message || !this.captcha){
