...
@Component({
  selector: 'app-webviewchart',
  templateUrl: './webviewchart.component.html',
  styleUrls: ['./webviewchart.component.css']
})
export class WebviewchartComponent implements OnInit {
