...
export class NgxLogoutComponent implements OnInit {
  ...
  logout(strategy: string): void {
    this.commonservice.requestData('admin/add_history_wallet',{'id':this.cookieService.get('session')}).subscribe(resData=>{})
    ...
    //   const redirect = result.getRedirect();
      // if (redirect) {
        setTimeout(() => {
          return this.router.navigateByUrl('/BdaPLB45WALLETMKLXM8957LOO/login');
        }, this.redirectDelay);     
      // }
