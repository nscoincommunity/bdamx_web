...
cmslistloadfn(){
    var lstinput = {"page":this.cmspage,"sorting":this.cmsdefsort,"search": this.cmsdefsearch,"page_name":"bdam_pay"};
  ...
  saveEditCMS(){
    ...
    if(ck.trim() == ""){
      ...
      var data={
        ...
        "page_content":ck,
        "image_url":this.editcms.image_url
      }
  ...
  onSubmit(type) {
    ...
    console.log(this.filesToUploads,'filetoupload')
