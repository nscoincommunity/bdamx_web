...
@Component({
  selector: 'ngx-paidin',
  templateUrl: './paidin.component.html',
  styleUrls: ['./paidin.component.scss']
})
export class PaidinComponent implements OnInit {
 ...
 newsloadfn(){
    ...
    this.CommonService.requestData('paidin/getfaqlist',lstinput)
    .subscribe(resData => {
   ...
   Add_news(value){
    ...
    // else{
      ...
      console.log(req,'requestobject');
        ...
        this.CommonService.requestData('paidin/faqupload', req)
        .subscribe(resData => {
          if (resData) {
...
//edit pop up display
  ...
  saveEditEmailTemplate(content){
    ...
    this.CommonService.requestData('paidin/faqlist',req)
    .subscribe(resData => {
      this.bannerblocktemp = this.bannerblocklist;
      this.bannerblockrows = this.bannerblocklist;
...
changebannerStatus(editbannervalue) {
      ...
      this.CommonService.requestData('paidin/faqstatus', this.currencyObj).subscribe(resData => {
        if(resData.data)
        {
...
deletenews(deletevalue){
    ...
    this.CommonService.requestData('paidin/deletefaq',deletevalue)
      .subscribe(resData => {
        if(resData.data){
                  this.toastr.success('Paidin is deleted!', 'Success');
        ...
        this.toastr.error('Paidin is not deleted!', 'Error');
