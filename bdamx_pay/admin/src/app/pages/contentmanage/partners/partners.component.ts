...
export class PartnersComponent implements OnInit {
   ...
   @ViewChild(DatatableComponent) partnerstable:DatatableComponent;
  ...
  onSubmit_nw(type) {
    ...
    .subscribe(files => {
        this.CommonService.requestData('partners/updateimage_nw',{"image":files.result.secure_url,"_id":this.editbanners._id}).subscribe(res=>{
          this.loader=false
 ...
 newsloadfn(){
    ...
    this.CommonService.requestData('partners/getfaqlist',lstinput)
    .subscribe(resData => {
   ...
   Add_news(value){
    ...
    // else{
      ...
      console.log(req,'requestobject');
        ...
        this.CommonService.requestData('partners/faqupload', req)
        .subscribe(resData => {
          if (resData) {
...
//edit pop up display
  ...
  saveEditEmailTemplate(content){
    ...
    this.CommonService.requestData('partners/faqlist',req)
    .subscribe(resData => {
      this.bannerblocktemp = this.bannerblocklist;
      this.bannerblockrows = this.bannerblocklist;
...
changebannerStatus(editbannervalue) {
      ...
      this.CommonService.requestData('partners/faqstatus', this.currencyObj).subscribe(resData => {
        if(resData.data)
        {
...
deletenews(deletevalue){
    ...
    this.CommonService.requestData('partners/deletefaq',deletevalue)
      .subscribe(resData => {
        if(resData.data){
                  this.toastr.success('Partners is deleted!', 'Success');
        ...
        this.toastr.error('Partners is not deleted!', 'Error');
