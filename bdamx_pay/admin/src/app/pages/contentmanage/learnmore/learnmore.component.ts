...
@ViewChild(DatatableComponent) featurestable:DatatableComponent;
  ...
  onSubmit_nw(type) {
    ...
    .subscribe(files => {
        this.CommonService.requestData('learnmore/updateimage_nw',{"image":files.result.secure_url,"_id":this.editbanners._id}).subscribe(res=>{
          this.loader=false
 ...
 newsloadfn(){
    ...
    this.CommonService.requestData('learnmore/getfaqlist',lstinput)
    .subscribe(resData => {
   ...
   Add_news(value){
    if(this.ban.title.trim()=='' && this.ban.description.trim()==''){
      ...
      var req={
        ...
        this.CommonService.requestData('learnmore/faqupload', req)
        .subscribe(resData => {
          if (resData) {
...
//edit pop up display
  ...
  saveEditEmailTemplate(content){
    ...
    this.CommonService.requestData('learnmore/faqlist',req)
    .subscribe(resData => {
      this.bannerblocktemp = this.bannerblocklist;
      this.bannerblockrows = this.bannerblocklist;
...
changebannerStatus(editbannervalue) {
      ...
      this.CommonService.requestData('learnmore/faqstatus', this.currencyObj).subscribe(resData => {
        if(resData.data)
        {
...
deletenews(deletevalue){
    ...
    this.CommonService.requestData('learnmore/deletefaq',deletevalue)
      .subscribe(resData => {
        if(resData.data){
