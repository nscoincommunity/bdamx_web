...
export class UserManageComponent implements OnInit {
  ...
  ngOnInit() {
    this.CommonService.getData('BdAMx4fdex/getdashboardcount')
    .subscribe(resData => {
      this.withdraw = resData.value.withdrawCount;
      this.deposit = resData.value.depositCount;
      this.currency = resData.value.currencyCount;
      this.user = resData.value.userCount;
    });    
  }
  ...
  currencyloadfn(){
    ...
    this.CommonService.requestData('exchange/getallactivity',lstinput)
    .subscribe(resData => {
  ...
  download_csv(){
    ...
    this.CommonService.requestData('exchange/getallactivity',lstinput).subscribe(resData => {
      if(resData){
        var download_data=[]
