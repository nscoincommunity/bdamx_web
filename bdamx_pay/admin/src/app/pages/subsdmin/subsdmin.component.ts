...
@ViewChild(DatatableComponent) newstable:DatatableComponent;
  ...
  ngOnInit() {
		...
		this.addadmin.faq='0';
    this.addadmin.faqcategory='0';
    this.addadmin.benefits='0';
    this.addadmin.admin_bank_details='0';
    this.addadmin.exchangehistory='0';
    this.addadmin.usermanage='0';
    this.addadmin.ipblock='0';
    this.addadmin.admin_bank_info='0';
    this.addadmin.markets='0';
    this.addadmin.feature='0';
    this.addadmin.paidin='0';
    this.addadmin.partners='0';
    this.addadmin.customers='0';
    this.addadmin.type='0';
...
//edit pop up display
   ...
   openeditmodel(content,bannerrow) {
      ...
      var password  = CryptoJS.AES.decrypt(this.editadmin.admin_password, key, {iv: iv});
      console.log(password,'passwwwwrooooorrdddd')
      var decryptedPassword  = password.toString(CryptoJS.enc.Utf8)
      this.editadmin.admin_password= decryptedPassword;
      ...
      this.editadmin.faqcategory= this.editadmin.faqcategory.toString();
      this.editadmin.benefits= this.editadmin.benefits.toString();
      this.editadmin.admin_bank_details= this.editadmin.admin_bank_details.toString();
      this.editadmin.exchangehistory= this.editadmin.exchangehistory.toString();
      this.editadmin.usermanage= this.editadmin.usermanage.toString();
      this.editadmin.ipblock= this.editadmin.ipblock.toString();
      this.editadmin.admin_bank_info= this.editadmin.admin_bank_info.toString();
      this.editadmin.markets= this.editadmin.markets.toString();
      this.editadmin.feature= this.editadmin.feature.toString();
      this.editadmin.paidin= this.editadmin.paidin.toString();
      this.editadmin.partners= this.editadmin.partners.toString();
      this.editadmin.customers= this.editadmin.customers.toString();
      this.editadmin.type= this.editadmin.type.toString();
...
cancelemailtemp(){
  ...
  private getDismissReason(reason: any): string {
    ...
    this.addadmin.faqcategory=+this.addadmin.faqcategory;
    this.addadmin.benefits=+this.addadmin.benefits;
    this.addadmin.admin_bank_details=+this.addadmin.admin_bank_details;
    this.addadmin.exchangehistory=+this.addadmin.exchangehistory;
    this.addadmin.usermanage=+this.addadmin.usermanage;
    this.addadmin.ipblock=+this.addadmin.ipblock;
    this.addadmin.admin_bank_info=+this.addadmin.admin_bank_info;
		this.addadmin.news=+this.addadmin.news;
    this.addadmin.markets=+this.addadmin.markets;
    this.addadmin.feature=+this.addadmin.feature;
    this.addadmin.paidin=+this.addadmin.paidin;
    this.addadmin.partners=+this.addadmin.partners;
    this.addadmin.customers=+this.addadmin.customers;
    this.addadmin.type=+this.addadmin.type;
