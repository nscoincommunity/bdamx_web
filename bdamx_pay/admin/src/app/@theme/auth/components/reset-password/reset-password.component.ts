  ...
  template: `    
      ...
      <div class="links">
        <small class="form-text">
          Already have an account? <a routerLink="/0ec82d0ac9619f3c2a3ff2/login_form"><strong>Sign In</strong></a>
        </small>
      </div>
  `,
})
export class NgxResetPasswordComponent {
  ...
  requestPass(form: NgForm): void {
    ...
    this.submitted = true;
    this.CommonService.requestData('admin/resetpassword',this.user)
      .subscribe(resData => {
  ...
  ngOnInit(){
    this.route.params.subscribe(params => {
      ...
      this.CommonService.requestData('admin/check_time',req).subscribe(resData => {  
