...
@Component({
  selector: 'app-block-crypto',
  templateUrl: './block-crypto.component.html',
  styleUrls: ['./block-crypto.component.css']
})
export class BlockCryptoComponent implements OnInit {
